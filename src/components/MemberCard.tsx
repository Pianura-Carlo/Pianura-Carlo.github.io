...
export default function MemberCard({ member, onSelectMember, onViewProfile }: MemberCardProps) {
    ...
    >
      ...
      <div className="mt-6 pt-4 border-t border-pink-50/50 dark:border-pink-950/10 flex items-center justify-between gap-2">
        ...
        <button
          ...
          className="text-xs font-semibold text-pink-600 dark:text-pink-400 hover:text-pink-700 hover:bg-pink-50 dark:hover:bg-pink-950/30 px-3 py-2 rounded-lg flex items-center gap-1 cursor-pointer transition-all border border-pink-100 dark:border-pink-900/30"
        >
